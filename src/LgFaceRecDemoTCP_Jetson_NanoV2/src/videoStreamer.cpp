...
{
    return new (std::nothrow) VideoStreamer(0, videoFrameWidth, videoFrameHeight, 60, isCSICam);
}
...
{
    return new (std::nothrow) VideoStreamer(pFileName, videoFrameWidth, videoFrameHeight);
}
